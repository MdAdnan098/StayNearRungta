          ...
          <FormField label="Facilities (Suvidhayen)">
            <div className="checkbox-grid">
              <label className="checkbox-item">
                <input
                  type="checkbox"
                  checked={form.hasCooler}
                  onChange={(e) => set("hasCooler", e.target.checked)}
                />
                <span>Cooler diya hai</span>
              </label>
              <label className="checkbox-item">
                <input
                  type="checkbox"
                  checked={form.attachedBathroom}
                  onChange={(e) => set("attachedBathroom", e.target.checked)}
                />
                <span>Attached bathroom hai</span>
              </label>
              <label className="checkbox-item">
                <input
                  type="checkbox"
                ...
                />
                <span>Independent room/PG hai</span>
              </label>
              <label className="checkbox-item">
                <input
                  type="checkbox"
                  checked={form.electricityIncluded}
                  onChange={(e) => set("electricityIncluded", e.target.checked)}
                />
                <span>Bijli bill rent mein included</span>
              </label>
              <label className="checkbox-item">
                <input
                  type="checkbox"
                  checked={form.bedGaddaTakiya}
                  onChange={(e) => set("bedGaddaTakiya", e.target.checked)}
                />
                <span>Bed, gadda, takiya diya hai</span>
              </label>
            </div>
            <div style={{ marginTop: 8, fontSize: "0.75rem", color: t.textMuted }}>
              Jo box tick nahi karenge, uska matlab "nahi hai" maana jayega (e.g. attached bathroom tick nahi = common bathroom, independent tick nahi = family ke saath rehna).
            </div>
          </FormField>
