          ...
          >
            ...
            <div>
              <div style={{ marginBottom: 36 }}>
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0, fontSize: "0.92rem", lineHeight: 2 }}>
                  {[
                    { label: "Cooler is Available", value: property.hasCooler },
                    { label: "Attached Bathroom", value: property.attachedBathroom },
                    { label: "Room/PG/Lodge/Flat is Independent", value: property.isIndependent },
                    { label: "Bijli Bill is Included in Room Rent", value: property.electricityIncluded },
                    { label: "Bed, Takiya, Gadda Available", value: property.bedGaddaTakiyaProvided },
                  ].map(({ label, value }) => (
                    <li key={label} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "4px 0", borderBottom: `1px solid ${t.border}` }}>
                      <span style={{ color: t.textSub }}>{label}</span>
                      <span style={{ fontSize: "1.1rem", marginLeft: 12 }}>
                        {value
                          ? <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 26, height: 26, borderRadius: "50%", background: "#fff", border: "1.5px solid #22a84a" }}><span style={{ color: "#22a84a", fontWeight: 700, fontSize: "1rem" }}>✓</span></span>
                          : <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 26, height: 26, borderRadius: "50%", background: "#fff", border: "1.5px solid #e53e3e" }}><span style={{ color: "#e53e3e", fontWeight: 700, fontSize: "1rem" }}>✕</span></span>
                        }
                      </span>
                    </li>
                  ))}
